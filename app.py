...
app.config['MAIL_USERNAME'] = 'cullenfamily.memories@gmail.com'
app.config['MAIL_PASSWORD'] = 'dvqtfwzzpvlpsfac'
app.config['MAIL_DEFAULT_SENDER'] = 'cullenfamily.memories@gmail.com'
